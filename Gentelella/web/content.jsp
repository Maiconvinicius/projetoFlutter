        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <form action="./Cliente" method="post" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="apelido" class="form-control col-md-7 col-xs-12" type="text" name="apelido">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="nascimento" class="date-picker form-control col-md-7 col-xs-12" name="nascimento" required="required" type="text">
                                </div>
                            </div>
